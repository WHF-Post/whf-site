    ...
    <section id="about" className="py-20 px-6 bg-black text-white scroll-mt-20">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-gray-400 text-lg leading-relaxed">
          Whitehouse Films is the creative lab of 
          <span className="typewriter-text ml-2">Charles White</span> — an award-winning editor, filmmaker, and storyteller with 20+ years in the game. From major networks like BET, Fox News, and NFL Films to viral podcast moments and branded campaigns, WHF transforms raw footage into cinematic stories that connect.
        </p>
